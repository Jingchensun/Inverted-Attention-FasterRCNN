...
if __name__ == "__main__":
    ...
    # 数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='/home/jingchen/dataset/', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights-path', default='./IAN_save_weights/resNetFpn-model-12.pth', type=str, help='training weights')
